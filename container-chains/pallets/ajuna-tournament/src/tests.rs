use {
    ...
    sp_runtime::{bounded_vec, testing::H256},
};
...
mod tournament_inspector {
    ...
    fn get_active_tournament_config_works() {
        ...
        ExtBuilder::default().build().execute_with(|| {
            ...
            assert_eq!(
                TournamentAlpha::get_active_tournament_config_for(&SEASON_ID_2),
                None
            );
        });
    }
    ...
    fn get_active_tournament_config_doesnt_apply_to_different_pallet_instances() {
        ...
        ExtBuilder::default().build().execute_with(|| {
            ...
            assert_eq!(
                TournamentBeta::get_active_tournament_config_for(&SEASON_ID_1),
                None
            );
        });
    }
...
mod tournament_mutator {
    ...
    fn try_create_new_tournament_works() {
        ...
        ExtBuilder::default().build().execute_with(|| {
            ...
            assert_eq!(
                NextTournamentIds::<Test, Instance1>::get(SEASON_ID_1),
                tournament_id + 1
            );
        });
    }
    ...
    fn try_remove_latest_tournament_workflow() {
        ...
        let tournament_config_2 = tournament_config_1
            .clone()
            .start(105)
            .active_end(120)
            .claim_end(140);
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    ...
                    Some(TournamentScheduledAction::StartActivePhase(
                        SEASON_ID_1,
                        tournament_id_1
                    ))
                );
                assert_eq!(
                    ...
                    Some(TournamentScheduledAction::SwitchToClaimPhase(
                        SEASON_ID_1,
                        tournament_id_1
                    ))
                );
                assert_eq!(
                    ...
                    Some(TournamentScheduledAction::EndClaimPhase(
                        SEASON_ID_1,
                        tournament_id_1
                    ))
                );
                ...
                assert_ok!(TournamentAlpha::try_remove_latest_tournament_for(
                    &SEASON_ID_1
                ));
