...
use {
    ...
    sp_runtime::{testing::H256, ArithmeticError, DispatchError},
};
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                System::assert_last_event(mock::RuntimeEvent::AAvatars(
                    crate::Event::OrganizerSet { organizer: DAVE },
                ));
            });
    }
...
mod treasury {
    ...
    fn claim_treasury_works() {
        let season_1 = Season::default().mint_fee(MintFees {
            one: 12,
            three: 34,
            six: 56,
        });
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::claim_treasury(
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for i in 0..season_1_schedule.end {
                    let season_2_schedule = SeasonSchedule::default()
                        .early_start(i)
                        .start(i + 1)
                        .end(i + 2);
    ...
    fn set_season_should_reject_out_of_bound_variations() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for (season, error) in [
                    (
                        Season::default().max_variations(0),
                        Error::<Test>::MaxVariationsTooLow,
                    ),
                    (
                        Season::default().max_variations(1),
                        Error::<Test>::MaxVariationsTooLow,
                    ),
                    (
                        Season::default().max_variations(16),
                        Error::<Test>::MaxVariationsTooHigh,
                    ),
                    (
                        Season::default().max_variations(100),
                        Error::<Test>::MaxVariationsTooHigh,
                    ),
                ] {
                    assert_noop!(
    ...
    fn set_season_should_reject_out_of_bound_components_bounds() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for (season, error) in [
                    (
                        Season::default().max_components(0),
                        Error::<Test>::MaxComponentsTooLow,
                    ),
                    (
                        Season::default().max_components(1),
                        Error::<Test>::MaxComponentsTooLow,
                    ),
                    (
                        Season::default().max_components(33),
                        Error::<Test>::MaxComponentsTooHigh,
                    ),
                    (
                        Season::default().max_components(100),
                        Error::<Test>::MaxComponentsTooHigh,
                    ),
                ] {
                    assert_noop!(
...
mod minting {
    use {super::*, frame_support::traits::Currency};
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for payment in [MintPayment::Normal, MintPayment::Free] {
                    ...
                    assert_eq!(
                        Owners::<Test>::get(ALICE, SEASON_ID).len(),
                        owned_avatar_count
                    );
                    assert!(!CurrentSeasonStatus::<Test>::get().active);
                    ...
                    assert!(CurrentSeasonStatus::<Test>::get().active);
                    assert_eq!(
                        PlayerSeasonConfigs::<Test>::get(ALICE, season_id)
                            .stats
                            .mint
                            .first,
    ...
    fn mint_should_work_when_changing_to_season_with_higher_storage_tier() {
        ...
        ExtBuilder::default()
            .seasons(&[
                (SEASON_ID, Season::default()),
                (season_2_id, Season::default()),
            ])
            .schedules(&[
                (SEASON_ID, season_1_schedule.clone()),
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for payment in [MintPayment::Normal, MintPayment::Free] {
                    ...
                    assert_eq!(
                        System::block_number(),
                        (season_schedule.start + 1) + mint_cooldown
                    );
                    assert_ok!(AAvatars::mint(
                        RuntimeOrigin::signed(ALICE),
                        MintOption {
    ...
    fn set_free_mints_works() {
        ExtBuilder::default()
            ...
            .build()
            .execute_with(|| {
                assert_ok!(AAvatars::set_free_mints(
                    RuntimeOrigin::signed(ALICE),
                    BOB,
                    999
                ));
...
mod forging {
    use {super::*, sp_runtime::testing::H256};
    ...
    fn forge_works_for_season_1() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                let dna_before = [
                    0x33, 0x35, 0x34, 0x30, 0x15, 0x35, 0x11, 0x30, 0x12, 0x33, 0x33,
                ];
                let dna_after = [
                    0x33, 0x35, 0x34, 0x30, 0x15, 0x35, 0x31, 0x30, 0x32, 0x33, 0x33,
                ];
                ...
                let sacrifice_souls: SoulCount = sacrifice_ids
                    .iter()
    ...
    fn forge_works_for_season_1_with_high_tier_leader() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                let leader_dna = [
                    0x33, 0x35, 0x34, 0x30, 0x35, 0x35, 0x31, 0x30, 0x32, 0x33, 0x33,
                ];
    ...
    fn forge_should_work() {
        ...
        let mut assert_dna =
            |leader_id: &AvatarIdOf<Test>, expected_dna: &[u8], insert_dna: Option<&[u8]>| {
                ...
                if let Some(dna) = insert_dna {
                    Owners::<Test>::get(BOB, SEASON_ID)[1..=4]
                        .iter()
                        .for_each(|id| {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_dna(
                    &leader_id,
                    &[0x23, 0x22, 0x22, 0x22, 0x11, 0x11, 0x14, 0x11],
                    None,
                );
                ...
                assert_dna(
                    &leader_id,
                    &[0x23, 0x22, 0x22, 0x22, 0x21, 0x21, 0x14, 0x21],
                    None,
                );
    ...
    fn forge_should_update_max_tier_avatars() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    CurrentSeasonStatus::<Test>::get().max_tier_avatars,
                    max_tier_avatars
                );
                assert_ok!(AAvatars::forge(
                    RuntimeOrigin::signed(BOB),
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                for i in [0, 2] {
                    ...
                    assert_eq!(
                        original_leader.dna.to_vec()[i] >> 4,
                        RarityTier::Common as u8
                    );
                    assert_eq!(
                        forged_leader.dna.to_vec()[i] >> 4,
                        RarityTier::Legendary as u8
                    );
                }
                System::assert_last_event(mock::RuntimeEvent::AAvatars(
                    crate::Event::AvatarsForged {
                        avatar_ids: vec![(leader_id, 2)],
                    },
                ));
    ...
    fn forge_should_work_for_non_matches() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    forged_leader.souls,
                    original_leader.souls + original_sacrifice.souls
                );
    ...
    fn forge_should_ignore_low_tier_sacrifices() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    Avatars::<Test>::get(leader_id).unwrap().1.dna,
                    leader_avatar.1.dna
                );
            });
    }
                ...
                for i in 0..season.min_sacrifices {
                    assert_noop!(
                        AAvatars::forge(
                            ...
                            owned_avatars[0],
                            (0..i)
                                .map(|i| owned_avatars[i as usize + 1])
                                .collect::<Vec<_>>(),
                        ),
...
mod transferring {
    ...
    fn transfer_free_mints_should_work() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::transfer_free_mints(
                    RuntimeOrigin::signed(ALICE),
                    BOB,
                    10
                ));
                System::assert_last_event(mock::RuntimeEvent::AAvatars(
                    crate::Event::FreeMintsTransferred {
                        from: ALICE,
                        to: BOB,
                        how_many: 10,
                    },
    ...
    fn transfer_avatar_works() {
        ...
        ExtBuilder::default()
            .seasons(&[
                (
                    season_id_1,
                    Season::default().transfer_avatar_fee(avatar_transfer_fee_1),
                ),
                (
                    season_id_2,
                    Season::default().transfer_avatar_fee(avatar_transfer_fee_2),
                ),
            ])
            .balances(&[(ALICE, initial_balance)])
            .locks(&[
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    Owners::<Test>::get(ALICE, season_id_1).to_vec(),
                    alice_avatar_ids[1..]
                );
                ...
                assert_eq!(
                    ...
                    initial_balance - avatar_transfer_fee_1
                );
    ...
    fn transfer_avatar_works_on_transfer_closed_with_organizer() {
        ...
        ExtBuilder::default()
            .seasons(&[(
                SEASON_ID,
                Season::default().transfer_avatar_fee(avatar_transfer_fee),
            )])
            .organizer(BOB)
...
mod trading {
    use {super::*, sp_runtime::bounded_vec};
    ...
    fn remove_price_should_work() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::remove_price(
                    RuntimeOrigin::signed(BOB),
                    avatar_for_sale
                ));
                assert_eq!(Trade::<Test>::get(SEASON_ID, avatar_for_sale), None);
                System::assert_last_event(mock::RuntimeEvent::AAvatars(
                    crate::Event::AvatarPriceUnset {
                        avatar_id: avatar_for_sale,
                    },
                ));
            });
    ...
    fn buy_should_work() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    Balances::free_balance(ALICE),
                    alice_initial_bal - price - min_fee
                );
                ...
                assert_eq!(
                    Owners::<Test>::get(BOB, SEASON_ID).len(),
                    owned_by_bob.len() - 1
                );
...
mod account {
    ...
    fn upgrade_storage_should_work_on_different_beneficiary() {
        ExtBuilder::default()
            ...
            .schedules(&[(
                SEASON_ID,
                SeasonSchedule::default().early_start(10).start(20).end(30),
            )])
            .build()
            .execute_with(|| {
                assert_eq!(
    ...
    fn upgrade_storage_should_work_on_different_season() {
        ...
        ExtBuilder::default()
            .seasons(&[
                (season_1_id, Season::default()),
                (season_2_id, Season::default()),
            ])
            .schedules(&[
                (season_1_id, season_1_schedule),
                (season_2_id, season_2_schedule),
            ])
            .build()
            .execute_with(|| {
                assert_eq!(
...
mod nft_transfer {
    use {
        super::*, frame_support::traits::tokens::nonfungibles_v2::Inspect,
        pallet_ajuna_nft_transfer::traits::NftConvertible, sp_runtime::bounded_vec,
    };
    ...
    fn set_collection_id_works() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::set_collection_id(
                    RuntimeOrigin::signed(CHARLIE),
                    collection_id
                ));
    ...
    fn can_lock_avatar_successfully() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::prepare_avatar(
                    RuntimeOrigin::signed(ALICE),
                    avatar_id
                ));
                ...
                assert_ok!(AAvatars::lock_avatar(
                    RuntimeOrigin::signed(ALICE),
                    avatar_id
                ));
                ...
                for (attribute_code, attribute) in
                    <AvatarOf<Test> as NftConvertible<KeyLimit, ValueLimit>>::get_attribute_codes()
                        .iter()
                ...
                assert_eq!(
                    Avatars::<Test>::get(avatar_id).unwrap().0,
                    technical_account
                );
    ...
    fn can_unlock_avatar_successfully() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::unlock_avatar(
                    RuntimeOrigin::signed(ALICE),
                    avatar_id
                ));
    ...
    fn prepare_avatar_works() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    Preparation::<Test>::get(avatar_id).unwrap().to_vec(),
                    Vec::<u8>::new()
                );
                System::assert_last_event(mock::RuntimeEvent::AAvatars(
    ...
    fn unprepare_avatar_works() {
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::unprepare_avatar(
                    RuntimeOrigin::signed(ALICE),
                    avatar_id
                ));
                assert!(!Preparation::<Test>::contains_key(avatar_id));
...
mod affiliates {
    use {super::*, pallet_ajuna_affiliates::traits::*, sp_runtime::bounded_vec};
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                assert_eq!(
                    ...
                    AffiliatorState {
                        status: AffiliatableStatus::Affiliatable(1),
                        affiliates: 0
                    }
                );

                assert_ok!(AAvatars::add_affiliation(
                    RuntimeOrigin::signed(BOB),
                    None,
                    0
                ));
                ...
                System::assert_last_event(mock::RuntimeEvent::Affiliates(
                    pallet_ajuna_affiliates::Event::AccountAffiliated {
                        account: BOB,
                        to: ALICE,
                    },
                ));
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                assert_eq!(
                    pallet_ajuna_affiliates::Affiliators::<Test, AffiliatesInstance1>::get(ALICE),
                    AffiliatorState {
                        status: AffiliatableStatus::NonAffiliatable,
                        affiliates: 0
                    }
                );
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    pallet_ajuna_affiliates::Affiliators::<Test, AffiliatesInstance1>::get(ALICE),
                    AffiliatorState {
                        status: AffiliatableStatus::Affiliatable(0),
                        affiliates: 0
                    }
                );
                assert_eq!(
    ...
    fn remove_affiliate_chain() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_ok!(AAvatars::remove_affiliation(
                    RuntimeOrigin::signed(ALICE),
                    BOB
                ));
    ...
    fn set_rule_works() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                System::assert_last_event(mock::RuntimeEvent::Affiliates(
                    pallet_ajuna_affiliates::Event::RuleAdded {
                        rule_id: AffiliateMethods::Mint,
                    },
                ));
    ...
    fn clear_rule_works() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                System::assert_last_event(mock::RuntimeEvent::Affiliates(
                    pallet_ajuna_affiliates::Event::RuleCleared {
                        rule_id: AffiliateMethods::Mint,
                    },
                ));
            });
