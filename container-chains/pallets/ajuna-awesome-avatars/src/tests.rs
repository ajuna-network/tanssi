...
mod minting {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                for payment in [MintPayment::Normal, MintPayment::Free] {
                    ...
                    // check participation
                    assert_eq!(
                        seasons_participated.into_iter().collect::<Vec<_>>(),
                        vec![1]
                    );
    ...
    fn mint_should_work_when_changing_to_season_with_higher_storage_tier() {
        ...
        ExtBuilder::default()
            .seasons(&[
                (SEASON_ID, season_1.clone()),
                (season_2_id, season_2.clone()),
            ])
            .balances(&[(ALICE, 1_234_567_890_123_456)])
            .free_mints(&[(ALICE, 10)])
            .build()
    ...
    fn buy_should_work() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                treasury_balance_season_1 += min_fee;
                assert_eq!(
                    PlayerSeasonConfigs::<Test>::get(CHARLIE, SEASON_ID)
                        .stats
                        .trade
                        .bought,
                    1
    ...
    fn can_lock_avatar_successfully() {
        ...
        ExtBuilder::default()
            ...
            .execute_with(|| {
                ...
                assert_eq!(
                    Owners::<Test>::get(technical_account, SEASON_ID)[0],
                    avatar_id
                );
                assert_eq!(
