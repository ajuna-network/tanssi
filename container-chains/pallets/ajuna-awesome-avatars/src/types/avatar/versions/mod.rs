...
pub(crate) use {
    v1::{AttributeMapperV1, ForgerV1, MinterV1},
    v2::{AttributeMapperV2, ForgerV2, MinterV2},
    v3::{AttributeMapperV3, ForgerV3, MinterV3},
};

use {crate::*, frame_support::pallet_prelude::*, sp_std::vec::Vec};
