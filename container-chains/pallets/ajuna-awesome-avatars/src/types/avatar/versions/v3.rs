...
mod test {
    ...
    fn forge_probability_works() {
        ...
        let now = 1;
        assert_eq!(
            ForgerV3::<Test>::forge_probability(&avatar, &season, &now, 1),
            25
        );
        assert_eq!(
            ForgerV3::<Test>::forge_probability(&avatar, &season, &now, 2),
            50
        );
        assert_eq!(
            ForgerV3::<Test>::forge_probability(&avatar, &season, &now, 3),
            75
        );
        assert_eq!(
            ForgerV3::<Test>::forge_probability(&avatar, &season, &now, 4),
            100
        );
