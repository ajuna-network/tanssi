...
use {
    crate::types::{Avatar, ByteConvertible, Force, RarityTier},
    frame_support::{traits::Get, BoundedVec},
    pallet_ajuna_nft_transfer::traits::{NFTAttribute, NftConvertible},
    parity_scale_codec::alloc::string::ToString,
